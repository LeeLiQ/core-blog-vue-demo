...
namespace blog_webapi_vue.Common.Redis
{
    public class RedisCacheManager : IRedisCacheManager  //Since ConnectionMultiplexer is very resource comsuming, we use singleton pattern here.
    {
